...
_nori_skillsets_completions() {
  ...
  commands="login logout init search download install switch list link unlink download-skill external watch dir fork edit install-location syntax clear clear-current factory-reset completion help"
