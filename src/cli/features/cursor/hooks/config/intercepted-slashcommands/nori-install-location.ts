/**
 * Cursor intercepted slash command for showing install location
...
/**
 * Cursor nori-install-location intercepted slash command
 */
export const cursorNoriInstallLocation: InterceptedSlashCommand = {
