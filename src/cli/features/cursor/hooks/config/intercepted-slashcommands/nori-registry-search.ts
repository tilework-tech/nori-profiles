/**
 * Cursor intercepted slash command for searching profile packages
...
/**
 * Cursor nori-registry-search intercepted slash command
 */
export const cursorNoriRegistrySearch: InterceptedSlashCommand = {
  matchers: [
