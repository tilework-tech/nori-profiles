/**
 * Cursor intercepted slash command for downloading profile packages
...
/**
 * Cursor nori-registry-download intercepted slash command
 */
export const cursorNoriRegistryDownload: InterceptedSlashCommand = {
  matchers: [
