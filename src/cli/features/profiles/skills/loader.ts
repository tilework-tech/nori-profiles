...
import type { ProfileLoader } from "@/cli/features/profiles/profileLoaderRegistry.js";
...
const installSkills = async (args: { config: Config }): Promise<void> => {
  ...
  for (const entry of entries) {
    ...
    // @see src/cli/features/profiles/config/_mixins/_paid/skills/paid-recall/script.ts - Bundling docs
