---
description: Use this rule to split large plans into smaller chunks. This rule manages your context window for large tasks. Use it when a task will take a long time and cause context issues.
alwaysApply: false
---
